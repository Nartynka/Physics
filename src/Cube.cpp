...
#define SHOW_CUBE_DEBUG_LINES false
#define SHOW_COLLISION_SHAPE false

Cube::Cube(SDL_Renderer* renderer, const Vec2& pos, float angle) : pos(pos), angle(angle)
{
...
void Cube::Move(float dt)
{
	...
	if (frictionCoeff != 0)
	{
		...
		float frictionAcc = frictionForce / mass;
